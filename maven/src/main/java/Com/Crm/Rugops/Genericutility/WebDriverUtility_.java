...
public class WebDriverUtility_{
	/**
...
public void withToAlertWindowAndAccep(WebDriver driver,String expectedMsg )
{
Alert alt = driver.switchTo().alert();	
if(alt.getText().equals(expectedMsg)) {
	System.out.println("alert Message is Verified ");
}else {
	System.out.println("Alert Messaage is not verified ");
}
alt.accept();
}
/**
